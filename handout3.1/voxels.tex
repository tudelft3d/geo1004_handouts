...
In the example from \reffig{fig:rasterisation}, the pixellated curve is obtained using by calculating intersections between the original 1D curve and a set of \emph{targets} that are 1D line segments.
